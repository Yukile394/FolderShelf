...
class FloatingOverlayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Android 14+ "specialUse" on plan servis kurali geregi, servis
        // baslar baslamaz bildirim gosterilmelidir.
    ...
    private fun handleDrop(event: DragEvent) {
        ...
        for (i in 0 until clipData.itemCount) {
            ...
            try {
                ...
                serviceScope.launch {
                    // Surukle-birak ile gelen ogenin klasor mu dosya mi
                    // oldugunu kesin bilemeyiz; DocumentFile bunu kendi
                    // tespit eder (fromSingleUri + isDirectory kontrolu).
        ...
        if (!addedAny) showDragUnsupportedNotice()
    }
